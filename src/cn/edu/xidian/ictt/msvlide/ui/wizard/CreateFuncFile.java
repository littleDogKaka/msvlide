...
public class CreateFuncFile extends Wizard implements INewWizard {
	private CreateFuncFilePage page;
	private ISelection selection;

	/**
	 * Constructor for CreateFuncFile.
	 */
	public CreateFuncFile() {
		super();
	...
	public void addPages() {
		page = new CreateFuncFilePage(selection);
		addPage(page);
	}
